...
st.write("This will mean you own",100*vl_aura_amount/(total_vl_aura+vl_aura_amount),"% of vlAURA, a veBAL voting power of",voting_power)
st.write("This is projected to support",vebal_percentage * statistics.mean(justlstsavg),"dollars")
