...
@st.cache_resource
def getlstpools():
    lsts = ['wstETH','cbETH','staFiETH','ankrETH','rETH']
...
def getgaugeweight(id):
    ...
    contract_address = '0xC128468b7Ce63eA702C1f104D55A2566b13D3ABD5'
    ...
    result = contract.functions.gauge_relative_weight().call(id)
    return result
