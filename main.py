...
st.session_state['aura_share'] = st.slider("Select projected AURA veBAL %share", min_value=0.0, max_value=100.0,value=100*st.session_state.default_value,step=0.1, format="%f")/100
aura_revenue = []
